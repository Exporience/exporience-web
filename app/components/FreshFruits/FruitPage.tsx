...
const fruits = {
  ...
  salak: {
    ...
    specifications: [
      ...
      { title: "Shelf life", value: "4 weeks (refrigerated)" },
...
export default function FruitsPage() {
  ...
  return (
    <section className="relative w-full h-auto max-w-4xl xl:px-[36px] mx-auto p-8">
      <h2 className="text-4xl xl:text-[64px] xl:pt-[50px] xl:pb-[50px] font-semibold text-center text-black pb-[20px]">
        Our <span className="text-[#182989]">Fresh Fruits</span>
      </h2>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8">
        ...
        {/* Fruit Details with Glassmorphism */}
        <div className="flex-1 bg-white/30 backdrop-blur-lg border border-white/20 shadow-lg rounded-xl p-6">
      ...
      <div className="flex md:justify-center gap-20 md:gap-[154px] mt-7 pt-7 overflow-auto">
        {Object.entries(fruits).map(([key, value]) => (
          ...
          >
            <div className="w-[150px] h-[150px] rounded-full bg-white flex items-center justify-center shadow-md transition-transform duration-300 hover:scale-110">
              <Image
                src={value.image}
                alt={value.name}
                width={120}
